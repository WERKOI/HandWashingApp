var app = (function () {
    ...
    function create_fragment$3(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div0, "class", "progress-bar svelte-ptjvac");
    			set_style(div0, "width", /*progress*/ ctx[0] + "%");
    			attr(span, "class", "sr-only");
    			attr(div1, "bp", "offset-5@md 4@md 12@sm");
    			attr(div1, "class", "progress-container svelte-ptjvac");
    			attr(div2, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*secondLeft*/ 1) {
    			$$invalidate(2, progress = (totalSeconds - secondLeft) / totalSeconds * 100); //прогресс
    		}
    	};
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			div.innerHTML = `<img bp="offset-5@md 4@md 12@sm" src="handwashing.gif" alt="How to wash your hands." class="svelte-164ivcv"/>`;
    			attr(div, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			...
    			h3.innerHTML = `<a href="https://www.who.int/gpsc/clean_hands_protection/en/">&gt;
		Picture Source</a> 
	...
	<source src="public_sound.wav"/>&gt;`;
    			...
    			attr(h1, "class", "svelte-168c9vv");
    			attr(h3, "class", "svelte-168c9vv");
    		},
    		m(target, anchor) {
